...
const img = "https://picsum.photos/200"; // gives random image

// in the HTML file <!--writing text/JSX instead of text/Javascript to avoid getting errors warnings in the console-->
